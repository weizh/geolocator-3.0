...
public class AnnaLemmatizer implements edu.cmu.geolocator.nlp.Lemmatizer {
  ...
  public static edu.cmu.geolocator.nlp.Lemmatizer getInstance(String string) throws Exception {
    if (string.equalsIgnoreCase("es")) {
      if (eslemma == null)
        eslemma = new AnnaLemmatizer("res/es/CoNLL2009-ST-Spanish-ALL.anna-3.3.lemmatizer.model");
      return eslemma;
    }
    if (string.equalsIgnoreCase("en")) {
      if (enlemma == null)
        enlemma = new AnnaLemmatizer("res/en/CoNLL2009-ST-English-ALL.anna-3.3.lemmatizer.model");
      return enlemma;
    }
