...
public class ACE_En_FeatureGenerator {
  ...
  public ACE_En_FeatureGenerator(String language, Index index, String resourcepath) {
  ...
  public static void main(String argv[]) throws IOException, InterruptedException {
    ...
    // ="ct-only";
    // ="allbutpos";
    ACE_En_FeatureGenerator fgen = new ACE_En_FeatureGenerator(argv[0], ResourceFactory.getClbIndex(),
            argv[2]);
