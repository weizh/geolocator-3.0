...
//		System.out.println("Applying the part-of-speech tagger");
	...
	public static void main(String argv[]) {
		...
		ESAnnaPOSTagger postagger = new ESAnnaPOSTagger("res/es/CoNLL2009-ST-Spanish-ALL.anna-3.3.postagger.model");
  ...
  public static ESAnnaPOSTagger getInstance(){
    if (estagger==null)
      estagger =  new ESAnnaPOSTagger("res/es/CoNLL2009-ST-Spanish-ALL.anna-3.3.postagger.model");
    return estagger;
  }
